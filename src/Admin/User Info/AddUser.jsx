    ...
    <div className='flex items-center justify-center m-5 p-5'>
      <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        <form class="space-y-6" onSubmit={register}>
          <h5 class="text-2xl text-center font-medium text-gray-900 dark:text-white">Add User</h5>
          ...
          <div>
            ...
            <ul class="grid w-full gap-7 md:grid-cols-3">
              <li>
              ...
              <li>
                <input type="radio" id="hosting-mid" name="role" value="Doctor" class="hidden peer" onChange={e => SetRole("Doctor")} />
                <label for="hosting-mid" class="text-center inline-flex items-center justify-between w-full p-3 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-100 dark:peer-checked:bg:blue-100 peer-checked:border-blue-100 peer-checked:text-gray-100 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700" >
                  Doctor 🩺
                </label>
              </li>
              <li>
                <input type="radio" id="hosting-big" name="role" value="Admin" class="hidden peer" onChange={e => SetRole("Admin")} />
